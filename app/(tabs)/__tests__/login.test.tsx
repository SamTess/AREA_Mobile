...
describe('LoginScreen', () => {
    ...
    it('allows typing in identifier field', async () => {
        ...
        const identifierInput = screen.getByPlaceholderText('example@email.com / username');
    ...
    it('displays OAuth divider text', async () => {
        renderWithAuth(<LoginScreen />);

        expect(await screen.findByText(/Or continue with/)).toBeTruthy();
    });

    it('displays sign up prompt text', async () => {
        renderWithAuth(<LoginScreen />);

        expect(await screen.findByText(/Don't have an account/)).toBeTruthy();
    });
    ...
    it('handles empty identifier and password', async () => {
        renderWithAuth(<LoginScreen />);
